...
namespace GCB::GameEngine {
    ...
    void VirtualMachine::run() {
        ...
        while (running) {
            ...
            State::GameAction* action =
                gameState.getNextRunnableAction();
    ...
    void VirtualMachine::processAction(State::GameAction& action) {
        action.phase = State::GameAction::Phase::RESOLVED;
    }
    ...
    // void VirtualMachine::setPointer(size_t ptr) {
    //     pointer = ptr;
    // }

    // size_t VirtualMachine::getPointer() const {
    //     return pointer;
    // }
}